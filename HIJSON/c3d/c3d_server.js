...
var inputPaths = {
	config: __dirname + '/../json_input/progetto/config.json',
	architecture: __dirname + '/../json_input/progetto/architecture.json',
	furniture: __dirname + '/../json_input/progetto/furnitures.json'
};
