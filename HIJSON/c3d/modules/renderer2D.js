...
var orderLayers = function() {
	var orderClass = ['server','table','external_wall','internal_wall','stair',
	'scalini','lettino','lettinoFisio','poltronaChemio',
	'serieSedie','parallele','reception','door',
	'window','graphNode','graphArc','path'];
